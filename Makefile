...
CPPFLAGS = -I .
CFLAGS =-g -std=gnu99 -O1 -Wall -pthread
CXXFLAGS = -g -std=gnu++11 -O1 -Wall
LDFLAGS = -lrt -lpthread

SOURCES = main.c mzapo_phys.c mzapo_parlcd.c
SOURCES += lcd.c led.c game.c menu.c game.c playing_board.c queue.c snake.c input_handler.c end_game.c
...
#SSH_OPTIONS=-o 'ProxyJump=veselsa1@postel.felk.cvut.cz'
